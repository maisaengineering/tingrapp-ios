        ...
        withKnobColor1:(UIColor *)color1k andKnobColor2:(UIColor *)color2k withShine:(BOOL)shine
{
    ...
    if (self) {
        ...
        container.backgroundColor = [UIColor colorWithRed:225/255.0 green:225/255.0 blue:225/255.0 alpha:1.0];
        ...
        onLabel.font = [UIFont fontWithName:@"Helvetica" size:14];
        ...
        offLabel.font = [UIFont fontWithName:@"Helvetica" size:14];
